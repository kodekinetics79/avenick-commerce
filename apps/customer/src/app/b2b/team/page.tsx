...
export default async function B2BTeamPage({
  ...
  //
  // BOTH pending states are read, not just the actionable one. A queue showing
  // only PENDING_ADMIN_APPROVAL would leave an administrator who has been told
  // "Ahmed applied" staring at an empty panel while Ahmed has simply not opened
  // his confirmation email — so the unconfirmed ones are listed too, with no
  // buttons and a line saying who is being waited on.
