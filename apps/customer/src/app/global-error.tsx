...
/**
 * Root-layout failure boundary for the storefront. It renders its own document,
 ...
 *
 * THE COPY STAYS BILINGUAL, and that is not the defect it looks like. Every
 * other surface in this app draws its strings from next-intl, but this boundary
 * replaces the document: there is no provider, no locale cookie in scope and no
 * translator. Both scripts stacked is the honest option; a slash pair is not,
 * and neither is silently picking one audience.
 */
      ...
      <body>
        <div className="g-wrap">
          <div className="g-plate">
            ...
            <h1>{name} could not finish loading.</h1>
            ...
            <p>
              Retrying reloads the page. If it fails again, the reference below is what support will ask
              for.
            </p>
            <p dir="rtl">
              إعادة المحاولة تُعيد تحميل الصفحة. وإذا أخفقت مرة أخرى، فإن المرجع أدناه هو ما سيطلبه الدعم.
            </p>
