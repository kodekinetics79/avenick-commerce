      ...
      <MainLayout>
        <div className="bg-slate-50 min-h-screen">
          <div className="max-w-lg mx-auto px-4 py-20 text-center">
            ...
            <div className="bg-white rounded-2xl border border-border p-4 mb-6 text-sm text-start">
            ...
            <div className="flex gap-3 justify-center">
              <Link href="/account/orders" className="bg-slate-900 text-white px-5 py-2.5 rounded-xl text-sm font-semibold hover:bg-slate-800 transition-colors">My Orders</Link>
              <Link href="/support" className="border border-border px-5 py-2.5 rounded-xl text-sm font-semibold hover:bg-slate-50 transition-colors">Contact Support</Link>
            </div>
          </div>
        </div>
      </MainLayout>
                ...
                <div key={order.id} className="bg-white rounded-2xl border border-border p-4">
                  <div className="flex items-start justify-between gap-4">
                    ...
                    <button type="button" onClick={() => { setSelectedOrder(order.id); setStep("form"); }}
                      className="shrink-0 flex items-center gap-1.5 bg-slate-900 hover:bg-slate-800 text-white text-xs font-semibold px-3 py-2 rounded-xl transition-colors">
