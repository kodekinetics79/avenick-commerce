...
export async function PUT(req: NextRequest, { params }: { params: { id: string } }) {
  try {
    ...
    const doc = await reviewDocument(params.id, "REJECTED", admin.userId, parsed.data.reason);
    ...
    log.error("admin reject document failed", error, { scope: "compliance.reject", documentId: params.id });
